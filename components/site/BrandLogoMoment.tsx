...
export default function BrandLogoMoment() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 py-16 text-center sm:px-8 sm:py-20 lg:px-12 lg:py-[5.5rem]">
        <h2 className="mx-auto max-w-2xl text-[clamp(1.75rem,3.8vw,2.75rem)] font-light tracking-[-0.03em]">
          Ready when you are.
        </h2>
